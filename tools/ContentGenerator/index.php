...
$source = file_get_contents(__DIR__.'/source.txt');
...
for($i = 0; $i < 50; $i++) {
	...
	$date = Utils::getRandomDate(array(2014, 2015), $max_now = true);
...
$query = $db->prepare('INSERT INTO post (author, title, content, date) VALUES (:author, :title, :content, :date)');
